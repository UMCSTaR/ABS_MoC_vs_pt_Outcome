...
# load data inlcude fellowship 
medicare_abs_model_ready_no_na = readRDS("x:\\/George_Surgeon_Projects/MOC_vs_Outcome/data/medicare_abs_model_ready_ex_multi_include_fellowship.rds")
...
# include fellowship
save(death_model_bin, file = "X:\\George_Surgeon_Projects/MOC_vs_Outcome/model/death_model_bin_3_cert_cat_fellowship.rdata")
...
# include fellowship
save(cmp_model_bin, file = "X:\\George_Surgeon_Projects/MOC_vs_Outcome/model/cmp_model_bin_3_cert_cat_fellowship.rdata")


# models we have tried. Archived in August 2022 because we have decided to use
# all procedures, include fellowship trained surgeons and 3 certification categories.
# # covariates -------------------------------------------------------------------
# covariates = c(
#   # choose one cert status--
#   # 're_cert_status',
