...
# nrow(abs_gs) - nrow(abs_gs_76_17) # 8077
...
Exclusion: 
  ...
  - Fellowship or non-US trained surgeons (n = `r n_exclude`). 
    - Fellowship and Med school information is from ABS and Fellowship Council data.
...
The ABS gives 10 years for surgeons for the recertification. We keep cases that 10 years after the initial certification to better capture the impact of the recertification process. However, we excluded cases happened 20 years after the initial certification to exlude the re-recertification effect,.e. only the first recertification cases were included in the cohort.
...
# nrow(abs_medicare_10_20yr) #922457
# n_distinct(abs_medicare_10_20yr$npi) #10814
