...
# 
# abs_medicare_npi = abs_medicare %>%
#   select(npi)
# 
# save(abs_medicare, file = "X://George_Surgeon_Projects/MOC_vs_Outcome/data/abs_medicare_4_13.rdata")
# save(abs_medicare_npi, file = "X://George_Surgeon_Projects/MOC_vs_Outcome/data/abs_medicare_npi_4_13.rdata")
```


```{r, cache=TRUE}
load("/Volumes/George_Surgeon_Projects/MOC_vs_Outcome/data/abs_medicare_npi_4_13.rdata")
```
