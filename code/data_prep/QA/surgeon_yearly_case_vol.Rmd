...
```{r falied}
# sample surg 1104888114 -------------------------------------
# from NPPES: Plastic and Reconstructive Surgery Physician
medicare_abs_model_ready_no_na %>% filter(npi == 1104888114) # 1 case
abs_medicare_10yr %>% filter(npi == 1104888114) # 1 case; facility claim March 2011

# checked medicare analytic file before merge ABS, n case =1

# 100% carrier claims ---------------------------------------
# check all professional claims for this surgeon in 2011
carrier_phy_1104888114_2011 = read_csv( "/Volumes/George_Surgeon_Projects/MOC_vs_Outcome/data/QA/carrier_phy_1104888114_2011.csv")
