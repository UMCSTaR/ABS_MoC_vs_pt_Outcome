---
title: "Model Results using only Partial Colectomy"
author: "Xilin Chen"
date: "`r Sys.Date()`"
output: 
  html_document:
...
```{r}
#load models
load("/Volumes/George_Surgeon_Projects/MOC_vs_Outcome/model/partial_colectomy/death_model_bin.rdata")
load("/Volumes/George_Surgeon_Projects/MOC_vs_Outcome/model/partial_colectomy/cmp_model_bin.rdata")
```

## Partial Colectomy cohort
