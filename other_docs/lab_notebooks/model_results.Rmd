...
load("/Volumes/George_Surgeon_Projects/MOC_vs_Outcome/model/cmp_model_bin.rdata")
```
...
```{r}
load("/Volumes/George_Surgeon_Projects/MOC_vs_Outcome/model/cmp_model_bin_3_cert_cat.rdata")
load("/Volumes/George_Surgeon_Projects/MOC_vs_Outcome/model/death_model_bin_3_cert_cat.rdata")
```
