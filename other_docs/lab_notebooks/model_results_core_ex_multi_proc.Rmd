---
title: "Model Results for CORE procedure excluding multiple procedures"
author: "Xilin Chen"
date: "`r Sys.Date()`"
output: 
  html_document:
...
```{r}
#load models
load("/Volumes/George_Surgeon_Projects/MOC_vs_Outcome/model/death_model_core_bin_remove_multi_proc.rdata")
load("/Volumes/George_Surgeon_Projects/MOC_vs_Outcome/model/cmp_model_core_bin_remove_multi_proc.rdata")
```
