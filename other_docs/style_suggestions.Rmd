...
Any non-publication work should prefer html output as it will properly display tables and visualizations correctly and without additional effort, along with not requiring proprietary software to display.
